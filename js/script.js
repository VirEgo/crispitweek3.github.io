$("#selling ul li a").click(function (e) {
	e.preventDefault();
	$("#selling ul li a").removeClass('active');
	$(this).addClass('active');
})
//adaptive selling section click function
// $(".selling-nav-mobile ul li").click(function (e) {
// 	e.preventDefault();
// 	$("#selling .selling-wrapper .selling-nav-mobile ul li").removeClass('active-mobile-selling');
// 	$(this).addClass('active-mobile-selling');
